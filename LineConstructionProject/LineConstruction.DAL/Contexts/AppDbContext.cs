    ...
    public class AppDbContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<IdentityRole>().HasData(
                ...
                new IdentityRole { Id = "a923f5d6-8127-4f92-b34d-91f5a8c6a788", Name = "HR", NormalizedName = "HR" }
            );
            #endregion
            ...
            hr.PasswordHash = hasher.HashPassword(hr, "Hr12345!");
            ...
            modelBuilder.Entity<IdentityUserRole<string>>().HasData(
                ...
                new IdentityUserRole<string> { UserId = hr.Id, RoleId = "a923f5d6-8127-4f92-b34d-91f5a8c6a788" }
            );
            #endregion

            #region Seed Data
            modelBuilder.Entity<Foundation>().HasData(
                new Foundation { Id = 1, ConcretePrice = 200, ArmaturePrice = 150, KhamitPrice = 50, DrillingPriceEmployer = 100, KhamitPriceEmployer = 60, ConcretePriceEmployer = 180 }
            );

            modelBuilder.Entity<Masonry>().HasData(
                new Masonry { Id = 1, StonePrice = 80, CementPrice = 50, SandPrice = 40, WorkerSalary = 200 }
            );

            modelBuilder.Entity<Plaster>().HasData(
                new Plaster { Id = 1, WorkerSalaryForArea = 120, CementPrice = 70, SandPrice = 50 }
            );

            modelBuilder.Entity<Roof>().HasData(
                new Roof { Id = 1, ReykaPrice = 90, WorkerSalaryForArea = 150, NailPrice = 30, WoodPrice = 120, RoofingPrice = 180 }
            );
            #endregion
